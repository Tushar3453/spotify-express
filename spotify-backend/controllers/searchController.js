...
exports.searchTracks = async (req, res) => {
    ...
    if (!query) return res.status(400).json({ error: 'Search query "q" zaroori hai.' });
    ...
    try {
        ...
        res.status(500).json({ error: 'Spotify par search karte waqt error aa gaya.' });
    }
};
...
exports.getRecommendations = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ error: 'Recommendations fetch karte waqt error aa gaya.' });
    }
};
